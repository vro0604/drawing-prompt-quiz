...
この日のルーチンは、新しい候補を足していない。着手した時点では
**PR #3 が未選択の候補4件（P1〜P4）を運んでいて、まだ merge されていなかった**
ため。上の規則どおり、選ばれていない候補が残っているあいだは足さない。

その後 PR #3 は main へ入り、P1〜P4 は下の「候補」節に並んでいる。
**まだどれも選ばれていないので、次のルーチンも新しい候補を足さないこと。**
次に候補が要るのは、P1〜P4 が全部 `[x]` か `[-]` になってから。
