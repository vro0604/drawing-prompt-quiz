...
| 番号 | 状態 |
|---|---|
| 9 | 反映済み（2026-08-27）。この項目は消した |
| 1・3・4・6 | docs/QUEUE.md の未着手に並んでいる。着手したら消す |
| 2 | 保留のまま。1 が a に決まったので、次回あらためて出し直す |
| 5 | 未反映。roadmap.md の 83行目と 188〜205行目が Gmail と Resend で食い違ったまま |
| 7・8 | 追加の作業なし（7 はいまのまま、8 はこの形で続ける）。次回のルーチンが消してよい |
