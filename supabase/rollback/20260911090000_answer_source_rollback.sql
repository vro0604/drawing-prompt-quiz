-- ============================================================================
-- 20260911090000_answer_source.sql を取り消す（20260911090000 を当てる前の状態へ戻す）
-- ============================================================================
--
...
--   - D196 と D195（20260912100000 / 20260912090000）を先に取り消してある
--
-- 【流したあと】履歴から外す: npx supabase migration repair 20260911090000 --status reverted --linked
...
begin
  ...
  if to_regclass('public.system_answer_queue') is not null then
    raise exception '取り消しを止めました: 先に 20260912090000（D195）を取り消してください';
  end if;
end $$;
