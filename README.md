...
| `npm run test:tools` | **本番へ書く道具が、当てる前に断るべきものを断るか。**名前の取り違え・重複・当てる先の食い違いを断ること、途中で落ちたら1本も残らないこと、検査の後片づけがその実行で作った行だけを消し、消し損ねを合格にしないこと、検査用の利用者の見分けかた（3つの形・1か所）と片づけ道具の止まり方、初回利用の進みぐあいを数える SQL が人数を二重に数えないことを試す | 46項目<!--count:道具の自己試験--> |
