...
supabase/migrations/  59本<!--count:migration-->。スキーマと関数の全部
...
| `npm run test:tools` | **本番へ書く道具が、当てる前に断るべきものを断るか。**名前の取り違え・重複・当てる先の食い違いを断ること、途中で落ちたら1本も残らないこと、検査の後片づけがその実行で作った行だけを消し、消し損ねを合格にしないことを試す | 32項目<!--count:道具の自己試験--> |
